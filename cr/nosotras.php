        ...
        <div class="container">
            <div class="row justify-content-center ml-4 mr-4 ml-md-0 mr-md-0">
                ...
                <div class="col-md-3 col-12">
                    <div class="single-team-member">
                        <div class="member-image text-center">
                            <img src="img/team-img/meli.png" class="w-100" alt="">
                ...
                <div class="col-md-3 col-12">
                    <div class="single-team-member">
                        <div class="member-image text-center">
                            <img src="img/team-img/cande.png" class="w-100" alt="">
                            <div class="team-hover-effects">
                ...
                <div class="col-md-3 col-12">
                    <div class="single-team-member">
                        <div class="member-image text-center">
                            <img src="img/team-img/lu.png" class="w-100" alt="">
                            <div class="team-hover-effects">
            ...
            <div class="row justify-content-center">
                <div class="col-md-3 col-12">
                    <div class="single-team-member">
                        <div class="member-image text-center">
                            <img src="img/team-img/anto.png" class="w-100" alt="">
                            <div class="team-hover-effects">
                ...
                <div class="col-md-3 col-12">
                    <div class="single-team-member">
                        <div class="member-image text-center">
                            <img src="img/team-img/vale.png" class="w-100" alt="">
                            <div class="team-hover-effects">
