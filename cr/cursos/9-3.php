            ...
            <div class="row h-100">
                <div class="col-12 col-md-6">
                    <div class="wellcome-heading wow fadeInLeft" data-wow-delay="0.7s">
                        ...
                        <p class="text-dark">¿Tenes ganas de aprender herramientas que te ayuden a desarrollar tus habilidades de comunicación?<br>¡¡Entonces este taller es para vos!!</p>
                    </div>
                    ...
                    <button class="btn-acordeon wow fadeInUp" data-wow-delay="1s" type="button" data-toggle="collapse" data-target="#desc" aria-expanded="false" aria-controls="collapseExample">
                        ...
                        <div class="collapse" id="desc">
                            <div class="card card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <p class="mb-3">¿Tenes ganas de aprender herramientas que te ayuden a desarrollar tus habilidades de comunicación? ¿Querés comunicarte de manera más efectiva?<br></br>
                                        Entonces este taller es ideal para vos!! Obtendrás diferentes técnicas que te ayudarán a comunicarte de manera más efectiva y asertiva</p>
                                        <p>
                                        ¿Por qué es importante aprender a comunicarnos? Porque desarrollar tus habilidades comunicacionales te permitirá transmitir tus ideas con claridad, desarrollar la empatía con otras personas, mejorar tu escucha y comprender mejor a tus interlocutores.</p>
                                        <ul class="evento">
                                            <li>
                            ...
                            <div class="card card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <ul class="evento">
                                            <li>
                                                <p>¿Qué es la empatía? ¿Por qué es importante desarrollarla?</p>
                                            </li>
                                            <li>
                                                <p>Escucha Activa y presencia genuina</p>
                                            </li>
                                            <li>
                                                <p>Diferencia entre juicios y afirmaciones</p>
                                            </li>
                                            <li>
                                                <p>La importancia de la comunicación no verbal</p>
                                            </li>
                                            <li>
                                                <p>Feedback:¿Cómo darlo de manera constructiva?</p>
                                            </li>
                                            <li>
                                                <p>Comunicación y trabajo en equipo</p>
                                            </li>
                                        </ul>
                ...
                <div class="col-12 col-md-5 wow fadeInDown" data-wow-delay="1s" style="z-index:1000;">
                    <div class="precio">
                        ...
                        <a href="inscripcion-9-3.php" class="btn btn-primary mt-5">Inscribirse</a>
