...
$email_subject = "Administra tu tiempo";

$user_subject = "Finalizar inscripción";
...
$email_message = "Para finalizar tu inscripción deberas realizar tu depósito bancario aquí\n\n";
$email_message .= "Titular ME Motivador de Experiencias SAS \n\n";
$email_message .= "CUIT 30-71579237-7 \n\n";
$email_message .= "Moneda $ \n\n";
$email_message .= "Banco ICBC \n\n";
$email_message .= "Nueva Córdoba - Suc 887 \n\n";
$email_message .= "Nro de Cta Cte 887/02001366/78 \n\n";
$email_message .= "CBU 0150887902000001366785 \n\n";
...
if($mail_enviado)
{
echo "<script>location.href='gracias-23-3.php';</script>";
