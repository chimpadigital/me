            ...
            <div class="row h-100">
                <div class="col-12 col-md-6">
                    <div class="wellcome-heading wow fadeInLeft" data-wow-delay="0.7s">
                        ...
                        <h2>Administra tu tiempo</h2>
                        <p class="text-dark">¿Por qué están surgiendo cambios en la manera de hacer negocios? Este taller-debate te permitirá conocer algunos de los nuevos modelos de negocios, como así también reflexionar sobre los pro y contras de estos sistemas.</p>
                    </div>
                    <ul class="info-evento mb-5 wow fadeInLeft" data-wow-delay=".8s">
                        ...
                        <li>
                            ...
                            <h5>De 09:00 a 12:00 hs</h5>
                        </li>
                        <li>
                            <img src="../img/core-img/location-point.svg" alt="" class="float-left mr-4 icono-evento">
                            <h5>General Paz 1522, B° Cofico, Córdoba, Argentina</h5>
                        </li>
                    </ul>
                    ...
                    <button class="btn-acordeon wow fadeInUp" data-wow-delay="1s" type="button" data-toggle="collapse" data-target="#desc" aria-expanded="false" aria-controls="collapseExample">
                        ...
                        <div class="collapse" id="desc">
                            <div class="card card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <p class="mb-3">¿Por qué están surgiendo cambios en la manera de hacer negocios?<br></br>El mundo actual nos lleva hacia una actividad dinámica y proactiva en donde los emprendimientos necesitan construirse en torno a equipos altamente empoderados, administrados y dirigidos por una generación de líderes más jóvenes, globales y diversos, y donde los valores, el propósito organizacional y el impacto de nuestras acciones en la realidad local, se vuelven cruciales. Este taller-debate te permitirá conocer algunos de los nuevos modelos de negocios, como así también reflexionar sobre los pro y contras de estos sistemas.</p>
                                        <ul class="evento">
                                            <li>
                                                <p>Entregamos certificado de asistencia</p>
                                            </li>
                                            <li>
                                                <p>¡Dirigido al público en general con muchas ganas de aprender!</p>
                                            </li>
                                        </ul>
                            ...
                            <div class="card card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <ul class="evento">
                                        <li>
                                                <p>Nuevas Economías ¿qué son?</p>
                                            </li>
                                            <li>
                                                <p>¿Por qué necesitamos cambiar la manera de hacer negocios?</p>
                                            </li>
                                            <li>
                                                <p>Trabajando para el progreso de los 17 ODS</p>
                                            </li>
                                            <li>
                                                <p>Nuevas tendencias de modelo de negocios:<br>
                                                        - Economía colaborativa. De la propiedad al acceso.<br>
                                                        - Cooperativismo de Plataforma. Críticas al sistema de acceso.</p>
                                            </li>
                                            <li>
                                                <p>Sistema B, ¿el triple impacto en los negocios es posible?</p>
                                            </li>
                                            <li>
                                                <p>Monedas Sociales</p>
                                            </li>
                                            <li>
                                                <p>Soluciones innovadoras</p>
                                            </li>
                                            <li>
                                                <p>Proyectos de impacto y negocios inspiradores</p>
                                            </li>
                                            <li>
                                                <p>Ejemplos de marcas que están emprendiendo distinto</p>
                                            </li>
                ...
                <div class="col-12 col-md-5 wow fadeInDown" data-wow-delay="1s" style="z-index:1000;">
                    <div class="precio">
                        <h3 class="">Costo</h3>
                        <h1 class="mb-4">USD 50</h1>
                        
                        <a href="inscripcion-23-3.php" class="btn btn-primary mt-5">Inscribirse</a>
                ...
                <div class="row">
                    <div class="app_screenshots_slides owl-carousel">
                        <div class="single-shot">
                            <div class="single-team-member">
                                <div class="charlas-image">
                                    <img src="../img/charlas/9-3.jpg" alt="">
                                        ...
                                        <div class="charlas-social-icon">
                                            <a href="9-3.php">
                                                ...
                                                <ul class="d-inline-flex charla-info">
                                                    <li>
                                                        <i class="fa fa-calendar"></i> 9 / 3
                                                    </li>
                                                    <li>
                                                        <i class="fa fa-clock-o"></i> 09:00hs
                                                    </li>
                                                </ul>
                        ...
                        <div class="single-shot">
                            <div class="single-team-member">
                                <div class="charlas-image">
                                    <img src="../img/charlas/23-3.jpg" alt="">
                                    <div class="charlas-hover-effects">
                                        <div class="charlas-social-icon">
                                            <a href="23-3.php">
