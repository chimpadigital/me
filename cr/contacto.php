                        ...
                        <nav class="navbar navbar-expand-lg navbar-light">
                            ...
                            <div class="collapse navbar-collapse" id="ca-navbar">
                                ...
                                <ul class="navbar-nav ml-auto" id="nav" style="align-items: center;">
                                    ...
                                    <li class="nav-item"><a class="nav-link" href="contacto.php"><span class="active-nuevo-dos">Contacto</span></a></li>
                                    ...
                                    <li class="nav-item dropdown">
                                        <a class="nav-link dropdown-toggle" href="contacto.php" id="dropdown09" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="img/core-img/cr.png" class="pais" alt=""></a>
                                        <div class="dropdown-menu" aria-labelledby="dropdown09">
                                            <a class="dropdown-item" href="../ar/contacto.php"><img src="img/core-img/arg.png" class="pais" alt=""></a>
                                        </div>
                                    </li>
