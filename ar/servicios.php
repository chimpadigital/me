                            ...
                            <div class="collapse navbar-collapse" id="ca-navbar">
                                ...
                                <ul class="navbar-nav ml-auto" id="nav" style="align-items: center;">
                                    ...
                                    <li class="nav-item dropdown">
                                        <a class="nav-link dropdown-toggle" href="servicios.php" id="dropdown09" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="img/core-img/arg.png" class="pais" alt=""></a>
                                        <div class="dropdown-menu" aria-labelledby="dropdown09">
                                            <a class="dropdown-item" href="../cr/servicios.php"><img src="img/core-img/cr.png" class="pais" alt=""></a>
                                        </div>
                                    </li>
            ...
            <div class="container">
                ...
                <div class="row justify-content-between plantas">
                    <div class="col-6 col-md-2">
                        <img src="img/bg-img/planta1.svg" alt="">
                    </div>
                    <div class="col-6 col-md-2 text-right">
                        <img src="img/bg-img/planta2.svg" alt="">
                    </div>
                </div>
                            ...
                            <div class="card card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-12 mt-4 mt-lg-0">
                                        <img src="img/servicios/asesoria/estrategica.jpg" alt="">
                                    </div>
                        ...
                        <div class="collapse" id="2">
                            <div class="card card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-12 mt-4 mt-lg-0">
                                        <img src="img/servicios/asesoria/comunicacion.jpg" alt="">
                                    </div>
                        ...
                        <div class="collapse" id="3">
                            <div class="card card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-12 mt-4 mt-lg-0">
                                        <img src="img/servicios/asesoria/cultura.jpg" alt="">
                                    </div>
                        ...
                        <div class="collapse" id="4">
                            <div class="card card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-12 mt-4 mt-lg-0">
                                        <img src="img/servicios/asesoria/porganizacionales.jpg" alt="">
                                    </div>
                        ...
                        <div class="collapse" id="c1">
                            <div class="card card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-12 mt-4 mt-lg-0">
                                        <img src="img/servicios/cursos/atencion.jpg" alt="">
                                    </div>
                        ...
                        <div class="collapse" id="c-1">
                            <div class="card card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-12 mt-4 mt-lg-0">
                                        <img src="img/servicios/cursos/fortalezas.jpg" alt="">
                                    </div>
                        ...
                        <div class="collapse" id="c2">
                            <div class="card card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-12 mt-4 mt-lg-0">
                                        <img src="img/servicios/cursos/liderazgo.jpg" alt="">
                                    </div>
                        ...
                        <div class="collapse" id="c3">
                            <div class="card card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-12 mt-4 mt-lg-0">
                                        <img src="img/servicios/cursos/comunicacion.jpg" alt="">
                                    </div>
                        ...
                        <div class="collapse" id="c4">
                            <div class="card card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-12 mt-4 mt-lg-0">
                                        <img src="img/servicios/cursos/negociar.jpg" alt="">
                                    </div>
                        ...
                        <div class="collapse" id="c5">
                            <div class="card card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-12 mt-4 mt-lg-0">
                                        <img src="img/servicios/cursos/tiempo.jpg" alt="">
                                    </div>
                        ...
                        <div class="collapse" id="c6">
                            <div class="card card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-12 mt-4 mt-lg-0">
                                        <img src="img/servicios/cursos/feedback.jpg" alt="">
                                    </div>
                        ...
                        <div class="collapse" id="c7">
                            <div class="card card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-12 mt-4 mt-lg-0">
                                        <img src="img/servicios/cursos/felicidad-org.jpg" alt="">
                                    </div>
                        ...
                        <div class="collapse" id="t1">
                            <div class="card card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-12 mt-4 mt-lg-0">
                                        <img src="img/servicios/team/campeones.jpg" alt="">
                                    </div>
                        ...
                        <div class="collapse" id="t2">
                            <div class="card card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-12 mt-4 mt-lg-0">
                                        <img src="img/servicios/team/swing.jpg" alt="">
                                    </div>
                        ...
                        <div class="collapse" id="t3">
                            <div class="card card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-12 mt-4 mt-lg-0">
                                        <img src="img/servicios/team/confianza.jpg" alt="">
                                    </div>
                        ...
                        <div class="collapse" id="t4">
                            <div class="card card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-12 mt-4 mt-lg-0">
                                        <img src="img/servicios/team/equipo.jpg" alt="">
                                    </div>
                        ...
                        <div class="collapse" id="t5">
                            <div class="card card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-12 mt-4 mt-lg-0">
                                        <img src="img/servicios/team/yoga.jpg" alt="">
                                    </div>
                        ...
                        <div class="collapse" id="t6">
                            <div class="card card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-12 mt-4 mt-lg-0">
                                        <img src="img/servicios/team/innovacion.jpg" alt="">
                                    </div>
        ...
        <div class="container">
            <div class="row">
                        ...
                        <div class="collapse" id="w1">
                            <div class="card card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-12 mt-4 mt-lg-0">
                                        <img src="img/servicios/workshops/fluir.jpg" alt="">
                                    </div>
                        ...
                        <div class="collapse" id="w2">
                            <div class="card card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-12 mt-4 mt-lg-0">
                                        <img src="img/servicios/workshops/pasion.jpg" alt="">
                                    </div>
                        ...
                        <div class="collapse" id="w3">
                            <div class="card card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-12 mt-4 mt-lg-0">
                                        <img src="img/servicios/workshops/happy.jpg" alt="">
                                    </div>
                        ...
                        <div class="collapse" id="w4">
                            <div class="card card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-12 mt-4 mt-lg-0">
                                        <img src="img/servicios/workshops/felicidad.jpg" alt="">
                                    </div>
                        ...
                        <div class="collapse" id="w5">
                            <div class="card card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-12 mt-4 mt-lg-0">
                                        <img src="img/servicios/workshops/diversidad.jpg" alt="">
                                    </div>
                        ...
                        <div class="collapse" id="w6">
                            <div class="card card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-12 mt-4 mt-lg-0">
                                        <img src="img/servicios/workshops/empresab.jpg" alt="">
                                    </div>
                        ...
                        <div class="collapse" id="w7">
                            <div class="card card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-12 mt-4 mt-lg-0">
                                        <img src="img/servicios/workshops/desafio.jpg" alt="">
                                    </div>
                        ...
                        <div class="collapse" id="w8">
                            <div class="card card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-12 mt-4 mt-lg-0">
                                        <img src="img/servicios/workshops/pequenos.jpg" alt="">
                                    </div>
                ...
                <div class="col-12 col-md-5 order-md-8 order-7 wow fadeInRight order-5" data-wow-delay="0.3s">
                    <img src="img/ilustraciones/charlas.svg" alt="" class="mb-5">
                </div>
