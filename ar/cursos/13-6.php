            ...
            <div class="row h-100">
                <div class="col-12 col-md-6">
                    <div class="wellcome-heading wow fadeInLeft" data-wow-delay="0.7s">
                        ...
                        <h2>Conocé tus fortalezas</h2>
                        <p class="text-dark">¿Alguna vez te preguntaste en qué sos bueno? ¿Cómo aplicas en tu día a día tu mayor talento?<br>¡Vení y descubrí las 5 fortalezas que te hacen único!.</p>
                    </div>
                    ...
                    <button class="btn-acordeon wow fadeInUp" data-wow-delay="1s" type="button" data-toggle="collapse" data-target="#desc" aria-expanded="false" aria-controls="collapseExample">
                        ...
                        <div class="collapse" id="desc">
                            <div class="card card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <p class="mb-3">¿Sabías que el 2/3 de la población mundial no sabe en qué es bueno y qué solo el 17% de las personas que conocen sus fortalezas lo aplica en el trabajo? Te invitamos a formar parte de nuestro próximo curso, donde aprenderás herramientas que podrás aplicar en tu día a día para alcanzar la mejor versión de ti mismo<br></br>
                                        ¿Por qué trabajar sobre tus fortalezas? Porque conocerlas te permitirá potenciar tu trabajo, tus relaciones interpersonales y todo aquello que decidas emprender.</p>
                                        <ul class="evento">
                                            <li>
                            ...
                            <div class="card card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <ul class="evento">
                                            <li>
                                                <p>Principios de la psicología positiva</p>
                                            </li>
                                            <li>
                                                <p>Fortalezas vs Debilidades</p>
                                            </li>
                                            <li>
                                                <p>Método VIA: ¿Cuáles son las 5 fortalezas que te hacen único?</p>
                                            </li>
                                            <li>
                                                <p>Modelo PERMA</p>
                                            </li>
                                            <li>
                                                <p>Estado de Flow: ¿Qués es? ¿Es posible alcanzarlo?</p>
                                            </li>
                                            <li>
                                                <p>Herramientas para potenciar equipos de trabajo</p>
                                            </li>
                                        </ul>
