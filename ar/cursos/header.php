                            ...
                            <div class="collapse navbar-collapse" id="ca-navbar">
                                ...
                                <ul class="navbar-nav ml-auto" id="nav" style="align-items: center;">
                                    ...
                                    <li class="nav-item dropdown">
                                        <a class="nav-link dropdown-toggle" href="contacto.php" id="dropdown09" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="../img/core-img/arg.png" class="pais" alt=""></a>
                                        <div class="dropdown-menu" aria-labelledby="dropdown09">
                                            <a class="dropdown-item" href="../cr/contacto.php"><img src="../img/core-img/cr.png" class="pais" alt=""></a>
                                        </div>
                                    </li>
