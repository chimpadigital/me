    ...
    <section class="wellcome_area clearfix bg-white position-relative" id="home" style="z-index:0;">
        <div class="container h-100 mt-7">
            <div class="row h-100 align-items-center">
                <div class="col-12 col-md-4 mt-5 mt-lg-0 text-center text-lg-left">
                ...
                <div class="col-12 col-md-6 wow fadeInDown mt-7 mt-lg-0" data-wow-delay="1s" style="z-index:1000;">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="blog-post wow fadeInUp" data-wow-delay="0.2s">
                                ...
                                <div class="blog-content">
                                    ...
                                    <a href="" class="btn-primary btn-sm">VER NOTA</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
